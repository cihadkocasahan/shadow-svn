...
def api_login():
    config = load_config()
    data = request.json
    stored = config.get("dashboard_pass") or DEFAULT_PASS
...
<body>
    <div class="login-card">
        <h1>Shadow SVN</h1>
        <p class="hint">Varsayılan şifre: <code>admin</code></p>
    ...
    <modal id="settings-modal">
        <div class="modal-content">
            ...
            <div class="form-group">
                <label class="form-label">YENİ DASHBOARD ŞİFRESİ</label>
                <input type="password" id="s-pass" placeholder="Yeni şifre (boş = admin'e sıfırla)">
            </div>
            <p style="font-size:11px; color:#90A4AE; font-weight:700;">* Boş bırakırsanız şifre varsayılan <code>admin</code>'e sıfırlanır.</p>
